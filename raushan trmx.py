                  ...
                  ⠈⠳⢦⣿⣿⣿⣿⣿⣿⠟⠋⠁                
                    ...
                    ⠙⢿⣿⣿⠛                     
                     ⠈⠙⠛                      
                       ⣀    
{cyan_text}[*]⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱❊╌──┈⊰᯽⊱❊╌──┈⊰᯽⊱❊╌──┈⊰᯽⊱❊╌──┈⊰᯽⊱❊╌──┈⊰᯽⊱❊╌──┈⊰᯽⊱\n 
 {purple_text}_________________    _____________ ___  ____  ___________   
\______   \   _  \  /   _____/    |   \ \   \/  /\______ \  
 |       _/  /_\  \ \_____  \|    |   /  \     /  |    |  \ 
 |    |   \  \_/   \/        \    |  /   /     \  |    `   \
 |____|_  /\_____  /_______  /______/   /___/\  \/_______  /
        \/       \/        \/                 \_/        \/ 
...
def main_apv():
    ...
    try:
        ...
        with open('/data/data/com.termux/files/usr/bin/.SINGH-cov', 'w'):

            pass
        print("\nCopy the key and send it for approval.\n")
        sleep(6)
        os.system("xdg-open https://wa.me/+918294963350")
    ...
    try:
        ...
        if key1 not in r1:
            ...
            os.system(f'am start https://wa.me/+918294963350?text={tks}')
        else:
            main()
